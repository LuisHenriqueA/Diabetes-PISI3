...
def build_header():
    ...
    '<p>Esta página apresenta a partir da seguinte base de dados importada do'+\
    'Kaggle¹ (https://www.kaggle.com/datasets/alexteboul/diabetes-health-indicators-dataset).</p>'
